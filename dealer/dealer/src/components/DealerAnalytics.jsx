...
import { useAuth } from '../../../shared-frontend/context/AuthContext'
        ...
        {!showForm || isAuthenticating ? (
          ...
          >
            <div className="auth-header">
              <AgriLogo size="md" />
              <h2 className="auth-title-futuristic">Dealer Login</h2>
              <p className="auth-sub-futuristic">Sign in to manage your seed stock</p>
            </div>
            ...
            <div className="auth-footer-futuristic">
              <Link to="/register">Register as Dealer</Link>
              <span className="dot-sep" />
              <Link to="/forgot-password">Recover Key</Link>
              <span className="dot-sep" />
              <a href="http://localhost:5173/login">Login as Farmer</a>
            </div>
          </motion.div>
        )}
      </AnimatePresence>
